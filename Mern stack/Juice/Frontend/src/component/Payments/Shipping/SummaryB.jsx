...
const SummaryB = ({ setfinalamt }) => {
  ...
  // ✅ final amount (total already has discount applied from context)
  const finalAmount = total + shipping;

  // ✅ avoid re-render loop
  useEffect(() => {
    setfinalamt(finalAmount);
  }, [finalAmount, setfinalamt]);
    ...
    <div className="container py-3 bg-light">
      ...
      <div className="mt-4">
        ...
        <div className="mb-2 d-flex justify-content-between">
          ...
          <span className="gap-1 fw-semibold d-flex align-items-center">
            <span>-</span>
        ...
        <div className="d-flex justify-content-between align-items-start">
          ...
          <h5 className="fw-bold text-nowrap">
